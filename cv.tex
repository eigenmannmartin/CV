...
\makebox[0.6\linewidth][l]{\cvsubsubsection{Projects:} AS400 to SAP migration, Infrastructure virtualisation}%
...
\item Planning and executing virtualisation strategy
...
In a very limited time we had to kickstart and release the project. In the early phase of the project I used
...
Since the release in January 2018 I significantly extended the project scope, added funtionality, improved usability for patients and streamlined
...
\smallskip
This was the first web based product build exclusively for external stakeholders (BAG) and demostrated
